      ...
      >
        ...
        <div
          style={{
            ...
            background: active
              ? 'transparent'
              : 'linear-gradient(180deg, rgba(13,11,26,.35), rgba(13,11,26,.55))',
    ...
    >
      ...
      <div
        style={{
          ...
          transition:
            'transform .7s cubic-bezier(.4,0,.2,1), z-index 0s linear .35s',
          zIndex: aActive ? 10 : 2,
          filter: aActive ? 'none' : 'saturate(.7)',
        }}
      >
        <PhoneShell
          src={feat.screens[0].src}
          w={W}
          h={H}
          color={feat.color}
          active={aActive}
...
function FeatureCrossfade({
  ...
  return (
    ...
    >
      ...
      <div
        key={`in-${current}-${enterKey}`}
        className="psim-phone-enter"
        style={{
          position: 'absolute',
          inset: 0,
          display: 'flex',
